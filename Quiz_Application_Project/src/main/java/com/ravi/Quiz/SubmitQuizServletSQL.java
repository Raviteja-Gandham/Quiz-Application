...
@WebServlet("/SubmitQuizServletSQL")
public class SubmitQuizServletSQL extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                psUpdateOrInsert.setInt(2, attempts);
                psUpdateOrInsert.setInt(3, userId);
                psUpdateOrInsert.setString(4, quizName);
                psUpdateOrInsert.executeUpdate(); // Execute insert query
